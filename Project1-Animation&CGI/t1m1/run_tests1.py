...
def find_tests(theme):
    ...
    for dirpath, dirnames, filenames in os.walk("/home/yago/cursoAI/assignment-preview/t1m1/assets/{}/" .format(theme.dir)):
...
def main():
    ...
    for test in sorted(tests):
        ...
        subprocess.check_output(['/home/yago/cursoAI/assignment-preview/t1m1/build/FOSSSim/FOSSSim', '-s', '{}' .format(test),
                                 '-d', '0', '-o', '/home/yago/cursoAI/assignment-preview/t1m1/test_output.bin'])

        oracle = subprocess.check_output(['/home/yago/cursoAI/assignment-preview/t1m1/oracle/FOSSSimOracle{}' .format(theme.upper()),
                                          '-s', '{}' .format(test), '-d', '0', '-i', '/home/yago/cursoAI/assignment-preview/t1m1/test_output.bin'],
