...
def find_tests(theme):
    ...
    for dirpath, dirnames, filenames in os.walk("/home/yago/cursoAI/assignment-preview/t1m3/assets/{}/" .format(theme)):
...
def main():
    """Collect the tests for the current milestone and run them against the oracle.   yago/cursoAI/assignment-preview/t1m3/build
    ...
    for test in sorted(tests):
        ...
        subprocess.check_output(['/home/yago/cursoAI/assignment-preview/t1m3/build/FOSSSim/FOSSSim', '-s', '{}' .format(test),
                                 '-d', '0', '-o', '/home/yago/cursoAI/assignment-preview/t1m3/test_output.bin'])

        oracle = subprocess.check_output(['/home/yago/cursoAI/assignment-preview/t1m3/oracle/FOSSSimOracle{}' .format(theme.upper()),
                                          '-s', '{}' .format(test), '-d', '0', '-i', '/home/yago/cursoAI/assignment-preview/t1m3/test_output.bin'],
